...
%------------------------------------------------
\CVItem{ViewLift}{December 2018 - Present}{\textit{Vice President, Engineering}}
\begin{itemize}
	\item Report directly to the President, responsible for all aspects of platform and client technology.

	\item Build and maintain core platform for digital distribution of live and on-demand content. Build and maintain client apps and websites across all devices (iOS, Android, AppleTV, Roku, Amazon FireTV, XBox, PS5, Sony, Samung, LG etc.)
	
	\item Manage distributed team of dozens of engineers  (New York, India).
\end{itemize}
