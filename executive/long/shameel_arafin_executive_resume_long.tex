...
algebraist@gmail.com \\ % Your email address
...
\textbf{Twitter} \\
\href{https://twitter.com/algebraist}{@algebraist} \\ % Address 1
...
%------------------------------------------------
\CVItem{Fortune Media}{September 2019 - Present}{\textit{Vice President, Product}}
\begin{itemize}
	\item Report directly to the CTO, responsible for delivery of all Fortune Premium digital products and services: Subscription, Video Portal, Website, Mobile Apps, Conferences, Connect. 

	\item Operational oversight for Product and Engineering teams' efforts in the digital transformation of Fortune from legacy publisher to multi-platform media company.
	
	\item Interface between C-suite executives, and all strategic stakeholders: Editorial, Sales, Marketing, Operations, Product and Engineering.
\end{itemize}
...
\CVItem{Scrum Alliance}{February 2018 - February 2020}{\textit{Certified Scrum Product Owner}}
\Sep % Extra whitespace after the end of a major section
...
%------------------------------------------------
\begin{itemize}
 	\item Publishing, Documentary video, Running, Photography
\end{itemize}
