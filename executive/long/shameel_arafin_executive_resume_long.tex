...
environments, project manager at scale. Domain expertise focused on media 
...
\begin{itemize}
	...
	across all devices (iOS, Android, Roku, FireTV, etc.) Clients include NBCUniversal (streaming media), Monumental Sports Network (sports statistics and betting), NEOU (fitness).
