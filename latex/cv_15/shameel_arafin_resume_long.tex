...
\url{shameel@arafin.net} \\ % Your email address
% \url{@algebraist} \\ % Your URL
...
\aboutme{About Me}{Technology executive with extensive domain expertise in media, focused on digital journalism, documentary and online learning. 10+ years in web development, product management and project development.}
...
\CVItem{Credit Suisse First Boston Technology Group}{July 1998 - March 2002}{\textit{Senior Research Associate}}
\begin{itemize}
...
%------------------------------------------------
\CVItem{Deutsche Bank Securities Technology Group}{June 1997 - July 1998}{\textit{Research Assistant}}
\begin{itemize}
...
\CVItem{Professional}{}{Digital publishing, digital journalism, documentary video, interactive storytelling, web design.}

%------------------------------------------------

\CVItem{Personal}{}{Trail running, photography, poker.}
